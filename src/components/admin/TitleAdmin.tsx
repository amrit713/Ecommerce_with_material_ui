  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className=" flex items-center space-x-2   bg-white box_shadow p-1 rounded-md ">
          <SearchOutlinedIcon className="text-[32px] text-gray-400" />
          <InputBase placeholder="Search" className="bg-transparent" />

        </div>

        <Button variant="contained" className="capitalize" color="secondary" > <AddRoundedIcon className="mr-2"/> Add Product</Button>
      </div>
    </div>
  );
}
