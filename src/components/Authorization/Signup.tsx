  ...
  return (
    <div className="bg-white mt-36  m-auto max-w-[600px] min-w-[310px] rounded-lg box_shadow px-[48px] py-[32px] text-center space-y-6 ">
      ...
      <div className="">
        ...
        >
          By signing up, you agree to <Button className="capitalize font-semibold text-dark border-solid   hover:text-primary-dark duration-200 ease-linear">Terms & Condtion</Button> 
        </Typography>
        </div>
